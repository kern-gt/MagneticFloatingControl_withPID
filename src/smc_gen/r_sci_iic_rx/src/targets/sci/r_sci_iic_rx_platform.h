...
/* Include specifics for chosen MCU.  */
        ...
        #include "./rx111/r_sci_iic_rx111_private.h"
    #elif defined(BSP_MCU_RX110)
        #include "./rx110/r_sci_iic_rx110_private.h"
    #elif defined(BSP_MCU_RX113)
        #include "./rx113/r_sci_iic_rx113_private.h"
    #elif defined(BSP_MCU_RX130)
        #include "./rx130/r_sci_iic_rx130_private.h"
    #elif defined(BSP_MCU_RX230)
        #include "./rx230/r_sci_iic_rx230_private.h"
    #elif defined(BSP_MCU_RX231)
        #include "./rx231/r_sci_iic_rx231_private.h"
    #elif defined(BSP_MCU_RX23T)
        #include "./rx23t/r_sci_iic_rx23t_private.h"
    #elif defined(BSP_MCU_RX24T)
        #include "./rx24t/r_sci_iic_rx24t_private.h"
    #elif defined(BSP_MCU_RX63N)
        #include "./rx63n/r_sci_iic_rx63n_private.h"
    #elif defined(BSP_MCU_RX64M)
        #include "./rx64m/r_sci_iic_rx64m_private.h"
    #elif defined(BSP_MCU_RX65N)
        #include "./rx65n/r_sci_iic_rx65n_private.h"
    #elif defined(BSP_MCU_RX71M)
        #include "./rx71m/r_sci_iic_rx71m_private.h"
    #else
