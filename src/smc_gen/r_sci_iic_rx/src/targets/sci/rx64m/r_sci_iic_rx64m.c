...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx64m_private.h"
...
{
    volatile uint8_t __evenaccess * const ppcr = ((&PORT0.PCR.BYTE) + port_gr);
    volatile uint8_t __evenaccess * const ppdr = ((&PORT0.PDR.BYTE) + port_gr);
    volatile uint8_t __evenaccess * const podr0 = ((&PORT0.ODR0.BYTE) + (2 * (port_gr - PORT_ODR0_OFFSET)));
    volatile uint8_t __evenaccess * const podr1 = ((&PORT0.ODR1.BYTE) + (2 * (port_gr - PORT_ODR1_OFFSET)));
    volatile uint8_t __evenaccess * const pdscr = ((&PORT0.DSCR.BYTE) + port_gr);
 ...
 *                Sets ICMR1, ICBRL and ICBRH registers.
 * Arguments    : sci_iic_info_t * p_sci_iic_info     ;   IIC Information
 * Return Value : None
 **********************************************************************************************************************/
static void sci_iic_set_frequency (sci_iic_info_t * p_sci_iic_info)
...
{
    volatile uint8_t __evenaccess * const ppmr = ((&PORT0.PMR.BYTE) + port_gr);
    volatile uint8_t __evenaccess * const ppfs = ((((&MPC.P00PFS.BYTE) + (port_gr * 8)) + pin_num) - PORT_PFS_OFFSET);
...
static void sci_iic_clear_ir_flag (sci_iic_info_t * p_sci_iic_info)
{
    uint8_t internal_flag = 0U; /* Determines whether re-initialization is necessary. */
    sci_regs_t pregs = g_sci_iic_handles[p_sci_iic_info->ch_no]->prom->regs;
    volatile __evenaccess const sci_iic_ch_rom_t * prom = g_sci_iic_handles[p_sci_iic_info->ch_no]->prom;
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic0_txi_isr(vect=VECT_SCI0_TXI0))
static void sci_iic_int_sci_iic0_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic1_txi_isr(vect=VECT_SCI1_TXI1))
static void sci_iic_int_sci_iic1_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic2_txi_isr(vect=VECT_SCI2_TXI2))
static void sci_iic_int_sci_iic2_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic3_txi_isr(vect=VECT_SCI3_TXI3))
static void sci_iic_int_sci_iic3_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic4_txi_isr(vect=VECT_SCI4_TXI4))
static void sci_iic_int_sci_iic4_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic5_txi_isr(vect=VECT_SCI5_TXI5))
static void sci_iic_int_sci_iic5_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic6_txi_isr(vect=VECT_SCI6_TXI6))
static void sci_iic_int_sci_iic6_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic7_txi_isr(vect=VECT_SCI7_TXI7))
static void sci_iic_int_sci_iic7_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic12_txi_isr(vect=VECT_SCI12_TXI12))
static void sci_iic_int_sci_iic12_txi_isr (void)
{
