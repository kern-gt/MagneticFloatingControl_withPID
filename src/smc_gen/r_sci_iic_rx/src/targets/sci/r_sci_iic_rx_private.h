...
/* SCI0 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI0_SSCL0_PORT) && (('J') >= R_SCI_IIC_CFG_SCI0_SSCL0_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI0_SSDA0_PORT) && (('J') >= R_SCI_IIC_CFG_SCI0_SSDA0_PORT))
...
/* SCI1 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI1_SSCL1_PORT) && (('J') >= R_SCI_IIC_CFG_SCI1_SSCL1_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI1_SSDA1_PORT) && (('J') >= R_SCI_IIC_CFG_SCI1_SSDA1_PORT))
...
/* SCI2 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI2_SSCL2_PORT) && (('J') >= R_SCI_IIC_CFG_SCI2_SSCL2_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI2_SSDA2_PORT) && (('J') >= R_SCI_IIC_CFG_SCI2_SSDA2_PORT))
...
/* SCI3 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI3_SSCL3_PORT) && (('J') >= R_SCI_IIC_CFG_SCI3_SSCL3_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI3_SSDA3_PORT) && (('J') >= R_SCI_IIC_CFG_SCI3_SSDA3_PORT))
...
/* SCI4 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI4_SSCL4_PORT) && (('J') >= R_SCI_IIC_CFG_SCI4_SSCL4_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI4_SSDA4_PORT) && (('J') >= R_SCI_IIC_CFG_SCI4_SSDA4_PORT))
...
/* SCI5 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI5_SSCL5_PORT) && (('J') >= R_SCI_IIC_CFG_SCI5_SSCL5_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI5_SSDA5_PORT) && (('J') >= R_SCI_IIC_CFG_SCI5_SSDA5_PORT))
...
/* SCI6 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI6_SSCL6_PORT) && (('J') >= R_SCI_IIC_CFG_SCI6_SSCL6_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI6_SSDA6_PORT) && (('J') >= R_SCI_IIC_CFG_SCI6_SSDA6_PORT))
...
/* SCI7 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI7_SSCL7_PORT) && (('J') >= R_SCI_IIC_CFG_SCI7_SSCL7_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI7_SSDA7_PORT) && (('J') >= R_SCI_IIC_CFG_SCI7_SSDA7_PORT))
...
/* SCI8 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI8_SSCL8_PORT) && (('J') >= R_SCI_IIC_CFG_SCI8_SSCL8_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI8_SSDA8_PORT) && (('J') >= R_SCI_IIC_CFG_SCI8_SSDA8_PORT))
...
/* SCI9 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI9_SSCL9_PORT) && (('J') >= R_SCI_IIC_CFG_SCI9_SSCL9_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI9_SSDA9_PORT) && (('J') >= R_SCI_IIC_CFG_SCI9_SSDA9_PORT))
...
/* SCI10 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI10_SSCL10_PORT) && (('J') >= R_SCI_IIC_CFG_SCI10_SSCL10_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI10_SSDA10_PORT) && (('J') >= R_SCI_IIC_CFG_SCI10_SSDA10_PORT))
...
/* SCI11 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI11_SSCL11_PORT) && (('J') >= R_SCI_IIC_CFG_SCI11_SSCL11_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI11_SSDA11_PORT) && (('J') >= R_SCI_IIC_CFG_SCI11_SSDA11_PORT))
...
/* SCI12 */
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI12_SSCL12_PORT) && (('J') >= R_SCI_IIC_CFG_SCI12_SSCL12_PORT))
    ...
    #elif ((('A') <= R_SCI_IIC_CFG_SCI12_SSDA12_PORT) && (('J') >= R_SCI_IIC_CFG_SCI12_SSDA12_PORT))
...
/* check of channel 0 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH0_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH0_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH0_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH0_SSCL_PIN) || (7 < SCI_IIC_CFG_CH0_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH0_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH0_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH0_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH0_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH0_SSDA_PIN) || (7 < SCI_IIC_CFG_CH0_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH0_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 1 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH1_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH1_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH1_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH1_SSCL_PIN) || (7 < SCI_IIC_CFG_CH1_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH1_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH1_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH1_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH1_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH1_SSDA_PIN) || (7 < SCI_IIC_CFG_CH1_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH1_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 2 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH2_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH2_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH2_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH2_SSCL_PIN) || (7 < SCI_IIC_CFG_CH2_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH2_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH2_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH2_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH2_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH2_SSDA_PIN) || (7 < SCI_IIC_CFG_CH2_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH2_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 3 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH3_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH3_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH3_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH3_SSCL_PIN) || (7 < SCI_IIC_CFG_CH3_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH3_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH3_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH3_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH3_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH3_SSDA_PIN) || (7 < SCI_IIC_CFG_CH3_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH3_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 4 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH4_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH4_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH4_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH4_SSCL_PIN) || (7 < SCI_IIC_CFG_CH4_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH4_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH4_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH4_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH4_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH4_SSDA_PIN) || (7 < SCI_IIC_CFG_CH4_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH4_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 5 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH5_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH5_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH5_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH5_SSCL_PIN) || (7 < SCI_IIC_CFG_CH5_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH5_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH5_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH5_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH5_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH5_SSDA_PIN) || (7 < SCI_IIC_CFG_CH5_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH5_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 6 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH6_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH6_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH6_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH6_SSCL_PIN) || (7 < SCI_IIC_CFG_CH6_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH6_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH6_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH6_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH6_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH6_SSDA_PIN) || (7 < SCI_IIC_CFG_CH6_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH6_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 7 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH7_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH7_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH7_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH7_SSCL_PIN) || (7 < SCI_IIC_CFG_CH7_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH7_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH7_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH7_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH7_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH7_SSDA_PIN) || (7 < SCI_IIC_CFG_CH7_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH7_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 8 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH8_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH8_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH8_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH8_SSCL_PIN) || (7 < SCI_IIC_CFG_CH8_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH8_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH8_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH8_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH8_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH8_SSDA_PIN) || (7 < SCI_IIC_CFG_CH8_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH8_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 9 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH9_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH9_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH9_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH9_SSCL_PIN) || (7 < SCI_IIC_CFG_CH9_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH9_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH9_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH9_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH9_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH9_SSDA_PIN) || (7 < SCI_IIC_CFG_CH9_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH9_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 10 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH10_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH10_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH10_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH10_SSCL_PIN) || (7 < SCI_IIC_CFG_CH10_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH10_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH10_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH10_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH10_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH10_SSDA_PIN) || (7 < SCI_IIC_CFG_CH10_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH10_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 11 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH11_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH11_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH11_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH11_SSCL_PIN) || (7 < SCI_IIC_CFG_CH11_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH11_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH11_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH11_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH11_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH11_SSDA_PIN) || (7 < SCI_IIC_CFG_CH11_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH11_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/* check of channel 12 */
        ...
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH12_SSCL_GP) || (0x14 < SCI_IIC_CFG_CH12_SSCL_GP))
            #error "ERROR - SCI_IIC_CFG_CH12_SSCL_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH12_SSCL_PIN) || (7 < SCI_IIC_CFG_CH12_SSCL_PIN))
            #error "ERROR - SCI_IIC_CFG_CH12_SSCL_PIN - Parameter error in configures file.  "
        #endif
        #if ((0x00 > SCI_IIC_CFG_CH12_SSDA_GP) || (0x14 < SCI_IIC_CFG_CH12_SSDA_GP))
            #error "ERROR - SCI_IIC_CFG_CH12_SSDA_GP - Parameter error in configures file.  "
        #endif
        #if ((0 > SCI_IIC_CFG_CH12_SSDA_PIN) || (7 < SCI_IIC_CFG_CH12_SSDA_PIN))
            #error "ERROR - SCI_IIC_CFG_CH12_SSDA_PIN - Parameter error in configures file.  "
        #endif
...
/*----------------------------------------------------------------------------*/
    ...
    #define SCI_IIC_NACK_RCV            ((uint8_t)(1))
