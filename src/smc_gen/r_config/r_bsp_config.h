...
*         : 13.04.2016 1.12    Added the following macro definition.
...
*                                - BSP_CFG_MCU_PART_ENCRYPTION_INCLUDED - C = false = Encryption module not included,
*                                                                                     SDHI module not included.
*                                                                       - G = true  = Encryption module included,
*                                                                                     SDHI module not included.
...
*/
#define BSP_CFG_MCU_PART_MEMORY_SIZE    (0x15)                                // <-- Updated by GUI. Do not edit this value manually
...
/* Heap size in bytes.
   ...
   3) Disable stdio from being built into the project library. This is done by going into the Renesas RX Toolchain 
      ...
      stdio.h. 
*/
#define BSP_CFG_HEAP_BYTES              (0x04)
...
/* External Bus Clock Divider (BCLK). 
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_BCK_DIV                 (1)                                // <-- Updated by GUI. Do not edit this value manually
