...
/* RIIC0 */
    ...
    #elif ((('A') <= R_RIIC_CFG_RIIC0_SCL0_PORT) && (('J') >= R_RIIC_CFG_RIIC0_SCL0_PORT))
    ...
    #elif ((('A') <= R_RIIC_CFG_RIIC0_SDA0_PORT) && (('J') >= R_RIIC_CFG_RIIC0_SDA0_PORT))
...
/* RIIC1 */
    ...
    #elif ((('A') <= R_RIIC_CFG_RIIC1_SCL1_PORT) && (('J') >= R_RIIC_CFG_RIIC1_SCL1_PORT))
    ...
    #elif ((('A') <= R_RIIC_CFG_RIIC1_SDA1_PORT) && (('J') >= R_RIIC_CFG_RIIC1_SDA1_PORT))
...
/* RIIC2 */
    ...
    #elif ((('A') <= R_RIIC_CFG_RIIC2_SCL2_PORT) && (('J') >= R_RIIC_CFG_RIIC2_SCL2_PORT))
    ...
    #elif ((('A') <= R_RIIC_CFG_RIIC2_SDA2_PORT) && (('J') >= R_RIIC_CFG_RIIC2_SDA2_PORT))
...
/* RIIC3 */
    #if ((('0') <= R_RIIC_CFG_RIIC3_SCL3_PORT) && (('9') >= R_RIIC_CFG_RIIC3_SCL3_PORT))
        #define RIIC_CH3_SCL3_GP (R_RIIC_CFG_RIIC3_SCL3_PORT - 0x30)
    #elif ((('A') <= R_RIIC_CFG_RIIC3_SCL3_PORT) && (('J') >= R_RIIC_CFG_RIIC3_SCL3_PORT))
        #define RIIC_CH3_SCL3_GP (R_RIIC_CFG_RIIC3_SCL3_PORT - 0x37)
    #else
        #error "Error! Invalid setting for R_RIIC_CFG_RIIC3_SCL3_PORT in r_riic_rx_pin_config.h"
    #endif
    #if ((('0') <= R_RIIC_CFG_RIIC3_SCL3_BIT) && (('7') >= R_RIIC_CFG_RIIC3_SCL3_BIT))
        #define RIIC_CH3_SCL3_PIN    (R_RIIC_CFG_RIIC3_SCL3_BIT - 0x30)
    #else
        #error "Error! Invalid setting for R_RIIC_CFG_RIIC3_SCL3_BIT in r_riic_rx_pin_config.h"
    #endif

    #if ((('0') <= R_RIIC_CFG_RIIC3_SDA3_PORT) && (('9') >= R_RIIC_CFG_RIIC3_SDA3_PORT))
        #define RIIC_CH3_SDA3_GP (R_RIIC_CFG_RIIC3_SDA3_PORT - 0x30)
    #elif ((('A') <= R_RIIC_CFG_RIIC3_SDA3_PORT) && (('J') >= R_RIIC_CFG_RIIC3_SDA3_PORT))
        #define RIIC_CH3_SDA3_GP (R_RIIC_CFG_RIIC3_SDA3_PORT - 0x37)
    #else
        #error "Error! Invalid setting for R_RIIC_CFG_RIIC3_SDA3_PORT in r_riic_rx_pin_config.h"
    #endif
    #if ((('0') <= R_RIIC_CFG_RIIC3_SDA3_BIT) && (('7') >= R_RIIC_CFG_RIIC3_SDA3_BIT))
        #define RIIC_CH3_SDA3_PIN    (R_RIIC_CFG_RIIC3_SDA3_BIT - 0x30)
    #else
        #error "Error! Invalid setting for R_RIIC_CFG_RIIC3_SDA3_BIT in r_riic_rx_pin_config.h"
    #endif
...
/* RIIC register setting */
    ...
    #if RIIC_CFG_TIMEOUT_ENABLE == 0
        #define RIIC_TMOE               ((uint8_t)(0x00))       /* Mask for ICFER.TMOE bit. */
    #elif RIIC_CFG_TIMEOUT_ENABLE == 1
        #define RIIC_TMOE               ((uint8_t)(0x01))       /* Mask for ICFER.TMOE bit. */
    #endif
...
/* Include specifics for chosen MCU.  */
        ...
        #include "./rx111/r_riic_rx111_private.h"
    #elif defined(BSP_MCU_RX110)
        #include "./rx110/r_riic_rx110_private.h"
    #elif defined(BSP_MCU_RX113)
        #include "./rx113/r_riic_rx113_private.h"
    #elif defined(BSP_MCU_RX64M)
        #include "./rx64m/r_riic_rx64m_private.h"
    #elif defined(BSP_MCU_RX65N)
        #include "./rx65n/r_riic_rx65n_private.h"
    #elif defined(BSP_MCU_RX71M)
        #include "./rx71m/r_riic_rx71m_private.h"
    #elif defined(BSP_MCU_RX231)
        #include "./rx231/r_riic_rx231_private.h"
    #elif defined(BSP_MCU_RX130)
        #include "./rx130/r_riic_rx130_private.h"
    #elif defined(BSP_MCU_RX230)
        #include "./rx230/r_riic_rx230_private.h"
    #elif defined(BSP_MCU_RX23T)
        #include "./rx23t/r_riic_rx23t_private.h"
    #elif defined(BSP_MCU_RX24T)
        #include "./rx24t/r_riic_rx24t_private.h"
    #else
