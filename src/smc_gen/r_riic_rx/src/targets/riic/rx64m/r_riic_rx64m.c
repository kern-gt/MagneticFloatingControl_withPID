...
void riic_mcu_io_open (uint8_t channel)
{
    ...
    switch (channel)
    {
        ...
        case 0x00 : /* Channel 0 */
            ...
            ppcr = ((&PORT0.PCR.BYTE) + port_gr);
            ppdr = ((&PORT0.PDR.BYTE) + port_gr);
...
void riic_mcu_mpc_enable (uint8_t channel)
{
    ...
    switch (channel)
    {
        ...
        case 0x00 : /* Channel 0 */
            ...
            port_gr = RIIC_CH0_SCL0_GP;
            pin_num = RIIC_CH0_SCL0_PIN;
            ppfs = ((((&MPC.P00PFS.BYTE) + (port_gr * 8)) + pin_num) - PORT_PFS_OFFSET);
...
static void riic0_txi_isr (void)
{
    riic0_txi_sub();
...
static void riic0_rxi_isr (void)
{
    riic0_rxi_sub();
