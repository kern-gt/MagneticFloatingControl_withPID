 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_riic_rx64m_private.h
 * Description  : Functions for using RIIC on RX devices. 
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * History : DD.MM.YYYY Version  Description
 *         : 22.09.2014 1.40     First Release
 ...
 **********************************************************************************************************************/
#ifndef RIIC_RX64M_PRIVATE_H
    #define RIIC_RX64M_PRIVATE_H
/***********************************************************************************************************************
 Macro definitions
 **********************************************************************************************************************/
...
/* mcu supported channels */
    ...
    #define RIIC_CFG_CH3_INCLUDED               (0U)
...
/*============================================================================*/
        ...
        #error "ERROR - RIIC_CFG_CH3_INCLUDED - RIIC3 is not supported in this device. "
    #endif
...
/*  RIIC0 Parameter check of Configuration Options */
    ...
    #if ((0x00 > RIIC_CH0_SCL0_GP) || (0x14 < RIIC_CH0_SCL0_GP))
        #error "ERROR - R_RIIC_CFG_RIIC0_SCL0_PORT - Parameter error in configures file.  "
    #endif

    #if ((0 > RIIC_CH0_SCL0_PIN) || (7 < RIIC_CH0_SCL0_PIN))
        #error "ERROR - R_RIIC_CFG_RIIC0_SCL0_BIT - Parameter error in configures file.  "
    #endif

    #if ((0x00 > RIIC_CH0_SDA0_GP) || (0x14 < RIIC_CH0_SDA0_GP))
        #error "ERROR - R_RIIC_CFG_RIIC0_SDA0_PORT - Parameter error in configures file.  "
    #endif

    #if ((0 > RIIC_CH0_SDA0_PIN) || (7 < RIIC_CH0_SDA0_PIN))
        #error "ERROR - R_RIIC_CFG_RIIC0_SDA0_BIT - Parameter error in configures file.  "
    #endif
...
/*  RIIC2 Parameter check of Configuration Options */
    ...
    #if ((0x00 > RIIC_CH2_SCL2_GP) || (0x14 < RIIC_CH2_SCL2_GP))
        #error "ERROR - R_RIIC_CFG_RIIC2_SCL2_PORT - Parameter error in configures file.  "
    #endif

    #if ((0 > RIIC_CH2_SCL2_PIN) || (7 < RIIC_CH2_SCL2_PIN))
        #error "ERROR - R_RIIC_CFG_RIIC2_SCL2_BIT - Parameter error in configures file.  "
    #endif

    #if ((0x00 > RIIC_CH2_SDA2_GP) || (0x14 < RIIC_CH2_SDA2_GP))
        #error "ERROR - R_RIIC_CFG_RIIC2_SDA2_PORT - Parameter error in configures file.  "
    #endif

    #if ((0 > RIIC_CH2_SDA2_PIN) || (7 < RIIC_CH2_SDA2_PIN))
        #error "ERROR - R_RIIC_CFG_RIIC2_SDA2_BIT - Parameter error in configures file.  "
    #endif
...
/* port register setting */
    #define PORT_PFS_OFFSET        (0)                               /* minimum PORT PIN NUM for PFS */
