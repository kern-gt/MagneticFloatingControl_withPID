...
/* Select the ports (SCL0 and SDA0) to use in RIIC0 */
    #define R_RIIC_CFG_RIIC0_SCL0_PORT   ('1')
    #define R_RIIC_CFG_RIIC0_SCL0_BIT    ('2')

    #define R_RIIC_CFG_RIIC0_SDA0_PORT   ('1')
    #define R_RIIC_CFG_RIIC0_SDA0_BIT    ('3')

/* Select the ports (SCL1 and SDA1) to use in RIIC1 */
    #define R_RIIC_CFG_RIIC1_SCL1_PORT   ('2')
    #define R_RIIC_CFG_RIIC1_SCL1_BIT    ('1')

    #define R_RIIC_CFG_RIIC1_SDA1_PORT   ('2')
    #define R_RIIC_CFG_RIIC1_SDA1_BIT    ('0')

/* Select the ports (SCL2 and SDA2) to use in RIIC2 */
    #define R_RIIC_CFG_RIIC2_SCL2_PORT   ('1')
    #define R_RIIC_CFG_RIIC2_SCL2_BIT    ('6')

    #define R_RIIC_CFG_RIIC2_SDA2_PORT   ('1')
    #define R_RIIC_CFG_RIIC2_SDA2_BIT    ('7')

/* Select the ports (SCL3 and SDA3) to use in RIIC3 */
    #define R_RIIC_CFG_RIIC3_SCL3_PORT   ('C')
    #define R_RIIC_CFG_RIIC3_SCL3_BIT    ('0')

    #define R_RIIC_CFG_RIIC3_SDA3_PORT   ('C')
    #define R_RIIC_CFG_RIIC3_SDA3_BIT    ('1')
